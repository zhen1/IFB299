            ...
            <tr>
                <td class="auto-style10" colspan="2">
                    <div style="width: 813px; margin: auto auto; font-family: 'Palatino Linotype'; font-size: 12pt; color: black; font-weight: bold">
                        Volunteer-Registration <a href="index.php" style="float: right">Login Here</a>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="vertical-align: top" colspan="2">
                    <div id="registermigrant" style="margin: auto auto">
                        <form method="post" action="doreg_volunteers.php">
                            <table cellpadding="0" cellspacing="0" align="center" style="border: solid 1px gray; font: normal 11pt 'palatino linotype'">
                                ...
                                <tr>
                                    <td class="auto-style3">&nbsp;</td>
                                    <td class="auto-style16">Work Area (PostCode):*</td>
                                    <td class="auto-style6">
                                        <input id="Text1" name="Textjobpostcode" maxlength="20" type="text" /></td>
                                    <td class="auto-style3">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="auto-style3">&nbsp;</td>
                                ...
                                <tr>
                                    <td class="auto-style3">&nbsp;</td>
                                    <td class="auto-style16">Your Address:*</td>
                                    <td class="auto-style6">
                                ...
                                <tr>
                                    <td class="auto-style3">&nbsp;</td>
                                    <td class="auto-style16">Your PostCode:*</td>
                                    <td class="auto-style6">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style16">&nbsp;</td>
                                    <td class="auto-style6">
                                        <input type="hidden" name="Cagree" value="0" />
                                        <input id="Checkbox1" type="checkbox" name="Cagree" value="1" />I agree to do this work in flexible schedule and also agree to it&#39;s terms and conditions. </td>
                                    <td class="auto-style3">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="auto-style3">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style16">&nbsp;</td>
                                    <td class="auto-style6">
                                        <input id="Submit1" type="submit" value="Apply For Volunteer" /></td>
                                    <td class="auto-style3">&nbsp;</td>
                                </tr>
                                <tr>
                                    <td class="auto-style3">&nbsp;</td>
