<!--
This page allows a staff member to create an account on behalf of a 
user rather than making them do it themselves. The system will automatically set a random number as the 
password and set the password as expired to force the user to change on first login
-->	
