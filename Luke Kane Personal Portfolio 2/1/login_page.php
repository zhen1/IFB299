<!-- 
This page is the main login page for the system. It checks the user provided password against the hash
stored in the system to verify if a user is able to login. It also determines if a user has an expired password, 
and redirects to appropriate page to change it. If password is expired the session is not logged in. If an
account has not been approved by a manager it is prevented from logging in.
-->
