<!--
This page is used for customers to signup for a new account. Checks to make sure username is unique.
Makes user type password in twice to ensure accuracy. Runs password through algorith to hash and salt
and stores this hash in the logins table.
